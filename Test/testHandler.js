...
} = require("./src/reductionEngineTest/reductionType1IntegrationTest");
const {
  reductionType2IntegrationTest,
} = require("./src/reductionEngineTest/reductionType2IntegrationTest");
class Test {
  constructor() {
    this.internal_state = [];
  }
