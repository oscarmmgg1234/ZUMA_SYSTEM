...
const delete_product = async (args) => {
  console.log("helper function", args.productID);
...
const deleteProduct = async (args) => {
 ...
 try {
   const { knex, updateVirtualPoolRefs } = require("../deps"); // however you import

   // Fetch product safely
   const [rows] = await knex.raw("SELECT * FROM product WHERE PRODUCT_ID = ?", [
     args.productID,
   ]);
