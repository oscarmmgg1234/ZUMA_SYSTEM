...
const removeToken = (token, productID) => {
  ...
  //remove B6WpKloH so then AC:1023:vJbYDU9O RD:10fd:vJbYDU9O UP:2j3w:vJbYDU9O UP:23hs:vJbYDU9O RD:10fd:B6WpKloH UP:23hs:B6WpKloH RD:10fd:40a1fbc3 UP:23hs:40a1fbc3
};
