...
const core_engine = async (args) => {
  ...
  try {
    ...
    db_handle = args.transactionHandle
      ? args.transactionHandle
      : await transactionUnit();
    ...
    try {
      ...
      console.log(processValid.validArr)
      return { processValidation: processValid, success: true };
    } catch (error) {
      throw error;
    }
  } catch (error) {
