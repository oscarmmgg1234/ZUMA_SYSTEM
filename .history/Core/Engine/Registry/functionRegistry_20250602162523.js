...
class FunctionRegistry {
  ...
  init() {
    ...
    this.registry_map.set("290W", {name: "Activate Product", desc: "Activate product -> option to completely activate without aditional steps", meta_data: {}, class: "AC", proto: async (db_handle, args, value, auxiliary) => {
      ...
      await ACUP_FUNCTION.proto(db_handle, args, value, {
        auxiliaryParam: auxiliary.auxiliaryParam,
        nextAuxiliaryParam: auxiliary.nextAuxiliaryParam,
        lastAuxiliaryParam: auxiliary.lastAuxiliaryParam,
      });
