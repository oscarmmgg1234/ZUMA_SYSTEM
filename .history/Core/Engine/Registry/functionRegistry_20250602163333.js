...
class FunctionRegistry {
  ...
  init() {
    ...
    this.registry_map.set("29ew", {name: "Reduce Product in 1 on 1 basis", desc: "Reduce product -> option to completely reduce without aditional steps", meta_data:  meta_data: {
      mainParams: 1,
      optionalParams: 1,
      optionalDesc: [
        {
