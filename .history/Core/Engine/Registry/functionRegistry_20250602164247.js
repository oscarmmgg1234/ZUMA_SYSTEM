...
class FunctionRegistry {
  ...
  init() {
    ...
    this.registry_map.set("290W", {name: "Activate Product on 1 on 1 basis", desc: "Activate product -> option to completely activate without aditional steps",  meta_data: {
      mainParams: 1,
      optionalParams: 1,
      optionalDesc: [
        {
      ...
      ]}, class: "AC", proto: async (db_handle, args, value, auxiliary) => {
    ...
    this.registry_map.set("29ew", {name: "Reduce Product in 1 on 1 basis", desc: "Reduce product -> option to completely reduce without aditional steps", meta_data: {
      mainParams: 1,
      optionalParams: 1,
      optionalDesc: [
        {
      ...
      ]}, class: "RD", proto: async (db_handle, args, value, auxiliary) => {
    ...
    this.registry_map.set("29wp", {
      ...
      proto: async (db_handle, args, value, auxiliary) => {
        //insert reduction record 
        await this.getFunction("739e").proto(db_handle, args, value, auxiliary);
      },
    });
