...
class FunctionRegistry {
  ...
  init() {
    ...
    this.registry_map.set("290W", {name: "Activate Product on 1", desc: "Activate product -> option to completely activate without aditional steps", meta_data: {}, class: "AC", proto: async (db_handle, args, value, auxiliary) => {
