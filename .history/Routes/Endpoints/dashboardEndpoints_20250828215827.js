...
dashboard_router.post("/updateTypeInfo", async (req, res) => {
  await endpoint_handler.services.updateTypeInfo(req, res);
});
dashboard_router.post("/manageTypes", async (req, res) => {
  await endpoint_handler.services.manageTypes(req, res);
});
dashboard_router.post("/updateProductType", async (req, res) => {
  await endpoint_handler.services.updateProductType(req, res);
});
dashboard_router.get("/getTypesWithProducts", async (req, res) => {
  await endpoint_handler.services.getTypesWithProducts(req, res);
});
dashboard_router.post("/updateCompanyInfo", async (req, res) => {
  await endpoint_handler.services.updateCompanyInfo(req, res);
});
