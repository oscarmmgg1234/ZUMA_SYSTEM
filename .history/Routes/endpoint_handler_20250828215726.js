...
class http_handler {
  ...
  services = {
    updateProductType: async (req, res) => {
      const result = await controller.dashboard_controller.updateProductType(
        req.body
      );
      res.send(result);
    },
    manageTypes: async (req, res) => {
      const result = await controller.dashboard_controller.manageTypes(
        req.body
      );
      res.send(result);
    },
    updateTypeInfo: async (req, res) => {
      const result = await controller.dashboard_controller.updateTypeInfo(
        req.body
      );
      res.send(result);
    },
    getTypesWithProducts: async (req, res) => {
      const response =
        await controller.dashboard_controller.getTypesWithProducts();
      res.send(response);
    },
    updateProductCompany: async (req, res) => {
      const result = await controller.dashboard_controller.updateProductCompany(
        req.body
      );
      res.send(result);
    },
    manageCompanies: async (req, res) => {
      const result = await controller.dashboard_controller.manageCompanies(
        req.body
      );
      res.send(result);
    },
    updateCompanyInfo: async (req, res) => {
      const result = await controller.dashboard_controller.updateCompanyInfo(
        req.body
      );
      res.send(result);
    },
